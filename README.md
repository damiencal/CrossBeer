...
- **yeoman** to scaffold angular - http://yeoman.io/
- **gulp** to run your tasks - http://gulpjs.com/
- **bower** to manage packages - http://bower.io/
...
Many automating tools:
- powerful collection of [gulp tasks](https://github.com/damiencal/CrossBeer#more-gulp-tasks)
- broad selection of [sub-generators](https://github.com/damiencal/CrossBeer#sub-generators)
- fine tuned [integration with git](https://github.com/damiencal/CrossBeer#git-integration)
...
│   │   ├──  ...
│   ├──  app.js               - application module, includes main module, ui-router etc ...
...
├──  README.md      - the CrossBeer README.md
</pre>
...
```
Head over to the [cordova cli documentation](http://cordova.apache.org/docs/en/edge/guide_cli_index.md.html#The%20Command-Line%20Interface) or their [github page](https://github.com/apache/cordova-cli/) to learn how to use the cordova cli.
...
```sh
gulp config --setVersion=0.0.1
gulp config --setBuild=1
gulp config --setBundle=io.cross.beer 
gulp config --setName='CrossBeer'
gulp config --setDescription='A community driven cheap beer finder app.'
gulp config --setAuthor='Your Name---contact@crossbeer.io---https://crossbeer.io'
```
...
1. [Mission Statement](https://github.com/damiencal/CrossBeer/wiki/Mission-Statement)
2. [Contribution Guide](https://github.com/damiencal/CrossBeer/wiki/Contribution-Guide)


## License
Code licensed under Apache License Version 2.0. Docs under Apache 2.
